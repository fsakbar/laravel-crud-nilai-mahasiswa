                                        ...
                                        @foreach ($data_mahasiswa as $mahasiswa)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="/mahasiswa/{{ $mahasiswa->id }}/delete"
    ...
    @section('content')
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <button type="button" class="btn btn-primary float-right float-end" data-bs-toggle="modal"
                    data-bs-target="#exampleModal">
                    Tambah Data Mahasiswa
                </button>
            ...
            <table class="table table-hover">
                ...
                @foreach ($data_mahasiswa as $mahasiswa)
                    <tr>
                        <td><a href="/mahasiswa/{{ $mahasiswa->id }}/profile" class="nav-link">{{ $mahasiswa->nim }}</a>
                        </td>
                        <td><a href="/mahasiswa/{{ $mahasiswa->id }}/profile" class="nav-link">{{ $mahasiswa->nama }}</a>
                        </td>
                        <td><a href="/mahasiswa/{{ $mahasiswa->id }}/profile"
                                class="nav-link">{{ $mahasiswa->program_studi }}</a></td>
                        <td><a href="/mahasiswa/{{ $mahasiswa->id }}/profile" class="nav-link">{{ $mahasiswa->no_hp }}</a>
                        </td>
                        <td>
